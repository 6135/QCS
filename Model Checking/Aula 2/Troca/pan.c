...
{	int j, h = now._nr_pr;
	...
	case 0:	/* Troca */
		...
		((P0 *)pptr(h))->_1_bb = 0;
#ifdef VAR_RANGES
		logval("Troca:a", ((P0 *)pptr(h))->_1_a);
		logval("Troca:b", ((P0 *)pptr(h))->_1_b);
		logval("Troca:aa", ((P0 *)pptr(h))->_1_aa);
		logval("Troca:bb", ((P0 *)pptr(h))->_1_bb);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{	/* int i; */
	switch(tp) {
	case 0:
		printf("local vars proc %d (Troca):\n", pid);
	printf("	int    a:	%d\n", ((P0 *)pptr(pid))->_1_a);
	printf("	int    b:	%d\n", ((P0 *)pptr(pid))->_1_b);
	printf("	int    aa:	%d\n", ((P0 *)pptr(pid))->_1_aa);
	printf("	int    bb:	%d\n", ((P0 *)pptr(pid))->_1_bb);
