...
{	int j, h = now._nr_pr;
	...
	case 0:	/* Q */
		...
		/* locals: */
		((P0 *)pptr(h))->_1_i = 1;
		((P0 *)pptr(h))->_1_result = 0;
		((P0 *)pptr(h))->_1_supposedRes = (((5*5)+5)/2);
#ifdef VAR_RANGES
		logval("Q:i", ((P0 *)pptr(h))->_1_i);
		logval("Q:result", ((P0 *)pptr(h))->_1_result);
		logval("Q:supposedRes", ((P0 *)pptr(h))->_1_supposedRes);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{	/* int i; */
	...
	printf("	int    i:	%d\n", ((P0 *)pptr(pid))->_1_i);
	printf("	int    result:	%d\n", ((P0 *)pptr(pid))->_1_result);
	printf("	int    supposedRes:	%d\n", ((P0 *)pptr(pid))->_1_supposedRes);
		break;
	}
}
void
